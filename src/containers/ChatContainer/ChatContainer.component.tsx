...
const ChatContainer = ({ client, username }: Props) => {
	...
	client.onmessage = (incomingMessage: any) => {
		...
		if (dataFromServer.type === 'newmessageevent' || dataFromServer.type === 'getallmessagesevent' || dataFromServer.type === 'editmessageevent' || dataFromServer.type === 'deletemessageevent') {
